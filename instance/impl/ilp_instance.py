...
class IlpInstance:
    ...
    def __init__(self, ilp, input_set, *args, **kwargs):
        self.ilp = ilp
        self.supbs = input_set
    ...
    def clauses(self):
        return self.ilp.clauses()

    def max_literal(self):
        return self.ilp.max_literal()

    def check(self):
        return isfile(self.ilp.path)
